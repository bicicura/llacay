        ...
        <div class="center-title__container">
            <div class="contact-container split">
                ...
                <div class="contact-text">
                    <p class="contact-text-small">Queremos saber en qué podemos ayudarte</p>
                ...
                <h2 class="contact-title">Contactános</h2>
                ...
                <form class="contact-form flex col" action="">
                    ...
                    <div class="contact-input__cont">
                        ...
                        <div class="contact-btn__container"><button>Envíar consulta</button></div>
                    </div>
                </form>
            </div>
